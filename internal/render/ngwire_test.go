...
func TestAllBuildersEmitNGSchema(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"WeatherPayload", WeatherPayload(WeatherClear, "21°", 21, hourly, 600)},
		{"WeatherPayloadMoon", WeatherPayloadMoon("21°", 21, hourly, MoonView{Illum: 0.5, Waxing: true}, 600)},
		{"WeatherPayloadNative", WeatherPayloadNative("1234", "21°", 21, hourly, 600)},
