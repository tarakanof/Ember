...
const sampleLaunchctlPrint = `com.awtrix-ai-status.heartbeat = {
	active count = 0
	path = /Users/dt/Library/LaunchAgents/com.awtrix-ai-status.heartbeat.plist
	state = not running
	program = /Users/dt/go/bin/awtrix-claude-producer
	runs = 7
	last exit code = 0
}`
