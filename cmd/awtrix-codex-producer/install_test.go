...
func TestGeneratePlist_DaemonShape(t *testing.T) {
	out := string(generatePlist("/Users/x/go/bin/awtrix-codex-producer", "/Users/x"))
	for _, want := range []string{
		"com.awtrix-ai-status.codex",
		"<key>KeepAlive</key>",
		"<key>RunAtLoad</key>",
		"<string>run</string>",
		"/Users/x/Library/Logs/awtrix-codex-producer.log",
	} {
...
func TestGeneratePlist_NoToken(t *testing.T) {
	out := string(generatePlist("/Users/x/go/bin/awtrix-codex-producer", "/Users/x"))
	if strings.Contains(out, "Bearer") || strings.Contains(out, "STATUS_TOKEN") {
